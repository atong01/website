...
### Recent News
* The Tong Group website is now live at [https://tonggroup.org/](https://tonggroup.org/).
* Co-organizing the [Non-Autoregressive Language Models](https://pengzhangzhi.github.io/NonAR-LM/) workshop at [**COLM**](https://colmweb.org/index.html) 2026 in San Francisco (Oct 9). **Submissions are due June 23, 2026 (AoE)** via OpenReview --- please consider submitting!
* Two papers accepted to **ICML** 2026. Checkout our work on autoregressive Boltzmann generators [ARBG](https://arxiv.org/abs/2606.27361) ([Danyal](https://danyalrehman.com)) (spotlight) and topological guidance for macrocycle generation [MacroGuide](https://arxiv.org/abs/2602.14977) (Alicja Maksymiuk).
...
* Two papers accepted to **ICML** 2025. Checkout our work on [Feynman-Kac
  Correctors](https://arxiv.org/abs/2503.02819) to guide diffusion models (spotlight)
